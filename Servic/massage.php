...
<body>
    ...
    <div class="container">
        <h1>Massage</h1>
        <img src="images/massage.png" alt="Massage" class="imgsize">
        <p>Unwind with our therapeutic massage services. Relieve stress and tension with techniques tailored to your wellness needs.</p>
