...
<html>
<head>
    <title>Servic - Plumbing Service</title>
...
<body>
    ...
    <div class="container">
        ...
        <img src="images/Plumbing.png" alt="Plumbing Service" class="imgsize">
        <p>Our professional plumbing services ensure your pipes flow smoothly. From leak repairs to new installations, our team handles it all with precision and care.</p>
