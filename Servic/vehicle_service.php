...
<html>
<head>
    <title>Servic - Vehicle Service</title>
...
<body>
    ...
    <div class="container">
        ...
        <img src="images/Vehicleservice.png" alt="Vehicle Service" class="imgsize"> 
        <p>Keep your vehicle in top condition with our comprehensive service checks and maintenance routines.</p>
