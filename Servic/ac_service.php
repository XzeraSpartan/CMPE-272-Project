...
<body>
    ...
    <div class="container">
        <h1>Ac Service</h1>
        <img src="images/acservice.png" alt="Ac Service" class="imgsize">
        <p>Stay cool and comfortable with our expert AC repair and maintenance services. Our certified technicians are equipped to handle all types of AC units, ensuring your system runs smoothly all year round.</p>
