...
<html>
<head>
    <title>Servic - Vehicle Towing</title>
...
<body>
    ...
    <div class="container">
        ...
        <img src="images/towing.png" alt="Vehicle Towing" class="imgsize">
        <p>Our towing services provide you with prompt assistance whenever you need it.</p>
