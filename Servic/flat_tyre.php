...
<body>
    ...
    <div class="container">
        <h1>Flat Tyre</h1>
        <img src="images/Flattyre.png" alt="Flat Tyre" class="imgsize">
        <p>Stranded with a flat? Our rapid tyre service will get you back on the road in no time.</p>
